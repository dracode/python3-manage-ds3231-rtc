...
parser = argparse.ArgumentParser(description='Enable the alarms on the DS3231.')
parser.add_argument('which_alarm', nargs='?', type=int, default=3, help='Which alarm (1 or 2) to enable; default BOTH.')
args = parser.parse_args()
if(args.which_alarm < 1 or args.which_alarm > 3):
  parser.error('Only valid alarm options are 1 or 2.')

if(args.which_alarm == 3):
  print('Enabling both alarms.')
else:
  print('Enabling alarm {}.'.format(args.which_alarm))
